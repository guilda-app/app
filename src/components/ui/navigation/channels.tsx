        ...
        <div className="mt-5">
            <div>
                ...
                {server.channels?.map((channel) => (
                    <HrefLink  href={`/app/server/${server.id}/channel/${channel.id}`} className="group select-none relative flex items-center overflow-hidden cursor-pointer transition-all duration-150 rounded-sm hover:bg-zinc-900 px-3 py-2 my-1 text-muted-foreground" key={channel.id}>
